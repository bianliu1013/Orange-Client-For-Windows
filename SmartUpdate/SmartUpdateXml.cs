...
namespace SmartUpdate
{
    public class SmartUpdateXml
    {
        ...
        public SmartUpdateXml(Version version, Uri uri, string fileName, string md5, string description, string launchArgs)
        {
        ...
        public static SmartUpdateXml Parse(Uri location, string appID)
        {
            ...
            try
            {
                ...
                return new SmartUpdateXml(version, new Uri(url), fileName, md5, description, launchArgs);
            }
            catch { return null; }
        }
    }
